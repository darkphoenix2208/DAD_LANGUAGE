...
var BlockStatement = /** @class */ (function (_super) {
    ...
    function BlockStatement(tokenExecutor, statementList) {
        var _this = _super.call(this, tokenExecutor) || this;
        _this._statementList = statementList;
        return _this;
    }
    BlockStatement.prototype.getStatement = function () {
        var _a;
        this._tokenExecutor.eatTokenAndForwardLookahead(dadLangSpec_1.TokenTypes.OPEN_CURLY_BRACE_TYPE);
        var body = ((_a = this._tokenExecutor.getLookahead()) === null || _a === void 0 ? void 0 : _a.type) ===
            dadLangSpec_1.TokenTypes.CLOSED_CURLY_BRACE_TYPE
            ? []
            : this._statementList.getStatementList(dadLangSpec_1.TokenTypes.CLOSED_CURLY_BRACE_TYPE);
        ...
        return {
            type: constants_1.NodeType.BlockStatement,
            body: body
        };
    };
